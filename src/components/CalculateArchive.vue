 <template>
  <div>
    ...
    <Jumbotron
      ...
      content="Select from the following ingredients when crafting your own flatbread or salad.  Use our calculator for accurate nutrition info."
    ></Jumbotron>      
    ...
    <div class="row justify-content-center">
      <div class="col-12 col-lg-8">
        <section class="px-3 py-3 mb-5">
          <h4>{{serving}} Size Nutrition Facts</h4>
          ...
          <div class="ingredients card-deck mb-4">
            <Ingredients
              ref="ing"
              v-for="item in filterCategory(this.ingredients, 'Sauce')"
              :key="item.id"
              :name="item.name"
              :type="item.type"
              :calories="( $store.state.portionSize === 'full') ? item.full.calories : item.half.calories"
